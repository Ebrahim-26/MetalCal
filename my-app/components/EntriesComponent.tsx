  ...
  return (
    <div className="flex items-center">
      <div className="bg-slate-300 p-4 rounded-lg flex gap-2 items-center m-2">
        <p className="text-lg font-bold">{metalName(item?.selectedMetal)}</p>
        <p className="text-lg font-bold bg-green-200 rounded-xl p-2">
          Weight: {item.weight}
        </p>
        <div className="flex flex-col gap-2">
          <p className="text-lg font-bold bg-amber-200 rounded-xl p-2">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-lg font-bold bg-amber-300 rounded-xl p-2">
        ...
        <p className="text-lg font-bold bg-red-200 rounded-xl p-2">
          Waste: {item.wastage}
        </p>
        <p className="text-lg font-bold bg-blue-200 rounded-xl p-2">
